...
## NG
Updated to work with clang-15 and Python3.  

Required tools: mininet gcc-multilib protobuf-compiler protobuf-c-compiler libprotobuf-c-dev libprotobuf-dev clang-15 git python3-protobuf python3-twisted
